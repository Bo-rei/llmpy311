# src/legacy/gate/ — Historical OOS Detection Gate Modules

This directory is legacy-only. The active protocol detector is implemented in
`src/protocol_v2/gate/multi_sphere_oos_detector.py`; this directory keeps a
