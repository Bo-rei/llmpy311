"""Lock a pre-declared K=1 diagonal-Mahalanobis Banking77 control.

Only Known train/dev rows are encoded here.  The geometry and the 90-percent
Known acceptance target are fixed before the separate final evaluator reads
test rows.  This is a targeted stability hypothesis, not a test-selected
winner.
"""
...
OUT = ART_ROOT / "fixed_k1_mahalanobis_known_only"
...
def main() -> None:
    ...
    manifest = {
        "status": "locking",
        "experiment": "banking77_textoir_aligned_fixed_k1_mahalanobis_known_only",
        "dataset": "banking77",
    ...
    for kir in KIRS:
        for seed in SEEDS:
            ...
            lock = {
                ...
                "geometry": {**GEOMETRY, "coverage": COVERAGE_TARGET, "threshold": threshold},
                ...
                "selection_evidence": {
                    ...
                    "selection_rule": "fixed K=1 diagonal Mahalanobis mean+1sigma no fusion; 90% Known-dev coverage",
                    "test_read": False,
                },
                "real_oos_used_for_training": False,
                "real_oos_used_for_selection": False,
    ...
    print("BANKING_TEXTOIR_ALIGNED_K1_MAHALANOBIS_LOCKED", flush=True)
