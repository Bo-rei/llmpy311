...
As shown in Table~\ref{tab:ablation_all_kir}, the results that the full pipeline of ours achieves the state-of-the-art performance, compared the ablation variants. That means, (i) the gate stage is essential for OOS rejection, (ii) hybrid MiniLMs in ours have more advantages.
