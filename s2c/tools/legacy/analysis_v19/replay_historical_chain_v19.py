...
def build_strict_eval_command(output_dir: str) -> List[str]:
    ...
    return [
        ...
        "--gate_detector_path",
        str(strict["frozen_detector_path"]),
        "--router_ckpt",
        str(strict["router_ckpt"]),
        "--experts_root",
        str(strict["experts_root"]),
        "--gate_mode",
        "multisphere",
        "--multi_prototype_path",
        str(strict["multi_prototype_path"]),
        "--semantic_gate_enabled",
        "--semantic_gate_mode",
        str(strict["semantic_gate_mode"]),
        "--semantic_gate_threshold",
        str(strict["semantic_gate_threshold"]),
        "--semantic_uncertain_low",
        str(strict["semantic_uncertain_low"]),
        "--semantic_uncertain_high",
        str(strict["semantic_uncertain_high"]),
        "--semantic_top_k",
        str(strict["semantic_top_k"]),
        "--prototype_centers_default",
        str(strict["prototype_centers_default"]),
        "--multi_proto_id_threshold",
        str(strict["multi_proto_id_threshold"]),
        "--multi_proto_threshold_mode",
        str(strict["multi_proto_threshold_mode"]),
        "--output_dir",
        str(output_dir),
    ]
