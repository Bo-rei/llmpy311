...
def build_figures(summary: list[dict[str, Any]], contracts: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    reused = [
        ...
        ("mechanism_pack_heatmap", "figures/archive/analysis/experimental_mechanism_pack_v3/oos_f1_method_kir_heatmap.png", "performance", "same_protocol_fair", "results/analysis/archive/analysis/experimental_mechanism_pack_v3/method_summary.csv"),
        ("mechanism_pack_paired_effects", "figures/archive/analysis/experimental_mechanism_pack_v3/trainable_paired_effects_heatmap.png", "paired_statistics", "same_protocol_fair", "results/analysis/archive/analysis/experimental_mechanism_pack_v3/method_summary.csv"),
        ("mechanism_closure_dashboard", "figures/archive/analysis/mechanism_closure_v1/mechanism_closure_dashboard.png", "mechanism", "same_protocol_fair", "results/analysis/archive/analysis/mechanism_closure_v1/MANIFEST.json"),
        ("mechanism_closure_mogb_risk", "figures/archive/analysis/mechanism_closure_v1/mogb_risk_workpoints.png", "mechanism", "same_protocol_fair", "results/analysis/archive/analysis/mechanism_closure_v1/MANIFEST.json"),
        ...
        ("statistical_forest", "figures/archive/analysis/statistical_stability_v1/paired_oos_f1_forest.png", "paired_statistics", "same_protocol_fair", "results/analysis/archive/analysis/statistical_stability_v1/MANIFEST.json"),
        ("statistical_rank_heatmap", "figures/archive/analysis/statistical_stability_v1/method_rank_heatmap_oos_f1.png", "performance", "same_protocol_fair", "results/analysis/archive/analysis/statistical_stability_v1/MANIFEST.json"),
        ("representation_geometry", "figures/archive/analysis/representation_geometry_visuals_v1/geometry_tradeoff.png", "representation", "mechanism", "results/analysis/archive/analysis/representation_geometry_visuals_v1/MANIFEST.json"),
        ("error_quadrants", "figures/archive/analysis/representation_geometry_visuals_v1/stackoverflow_error_quadrants.png", "error", "mechanism", "results/analysis/archive/analysis/representation_geometry_visuals_v1/MANIFEST.json"),
    ]
...
def write_report(summary: list[dict[str, Any]], contracts: list[dict[str, Any]], figures: list[dict[str, Any]], contract_result: Mapping[str, Any]) -> None:
    ...
    lines = [
        ...
        "已有的 score overlap、错误预算、KIR 曲线、Pareto、seed 稳定性和 MOGB risk workpoint 被统一收录到 `figure_manifest.json`。当前 checkout 没有统一可登记的 raw embedding，因此不伪造 error-aware UMAP。",
        "",
        "## 4. 表示、边界与 MOGB 机制",
        "",
        ...
        "- 当前证据入口：`docs/analysis/UNIFIED_COMPARISON_AND_MECHANISM_REPORT_V1.md`、`docs/analysis/VISUAL_ANALYSIS_INDEX_V1.md`；历史合同报告位于 `docs/archive/analysis/`。",
    ]
