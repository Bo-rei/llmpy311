...
def build(input_path: Path, output: Path, figures: Path, report: Path) -> None:
    ...
    lines = [
        ...
        "## 输出",
        "",
        "- `results/analysis/cross_kir_matched_frontier_v1/paired_frontier.csv`：同 dataset×KIR×seed×目标覆盖率的配对差值。",
        "- `results/analysis/cross_kir_matched_frontier_v1/summary.csv`：五 seed 均值、标准差、win/tie/loss。",
        "- `figures/cross_kir_matched_frontier_v1/matched_frontier_delta_heatmaps.png`：跨 KIR 的 OOS F1 差值热图。",
        "- `figures/cross_kir_matched_frontier_v1/matched_frontier_oos_f1_curves.png`：匹配 Known 覆盖率曲线。",
        "",
