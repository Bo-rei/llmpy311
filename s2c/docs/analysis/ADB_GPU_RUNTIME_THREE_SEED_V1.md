...
机器可读汇总：
`results/analysis/external_gpu_runtime_comparison_v1/stackoverflow_kir50_external_summary.csv`。
...
逐 seed 配对差异和标准差见：
`results/analysis/external_gpu_runtime_comparison_v1/adb_vs_trainable_paired_effects_summary.csv`。
...
- 比较审计：`results/analysis/external_gpu_runtime_comparison_v1/`
