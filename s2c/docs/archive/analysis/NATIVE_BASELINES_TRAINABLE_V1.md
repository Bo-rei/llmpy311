...
- `results/analysis/archive/analysis/native_baselines_trainable_v1/trainable_native_per_seed.csv`：逐 seed 结果。
- `results/analysis/archive/analysis/native_baselines_trainable_v1/trainable_native_vs_gate_paired.csv`：配对差值与 bootstrap CI。
- `results/analysis/archive/analysis/native_baselines_trainable_v1/trainable_vs_frozen_native_paired.csv`：表示替换差值。
- `figures/archive/analysis/native_baselines_trainable_v1/`：KIR 曲线与 KIR=.50 权衡图。
