...
`results/analysis/archive/analysis/minilm_trainable_kir_sweep_v1/`、`figures/archive/analysis/minilm_trainable_kir_sweep_v1/`。
...
来源：`results/analysis/archive/analysis/kir50_method_comparison_v1/mean_std.csv`、
`docs/archive/analysis/KIR50_METHOD_COMPARISON_V1.md`、`docs/对比实验/MOGB_DCLOOS_对比结果报告.md`。
