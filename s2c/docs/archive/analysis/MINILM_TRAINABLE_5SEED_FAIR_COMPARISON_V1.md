...
- `results/analysis/archive/analysis/minilm_trainable_5seed_fair_v1/`：五 seed 逐单元、均值、配对差值和历史参照 CSV。
- `figures/archive/analysis/minilm_trainable_5seed_fair_v1/trainable_vs_frozen_5seed_kir.png`：Trainable/Frozen KIR 曲线。
- `figures/archive/analysis/minilm_trainable_5seed_fair_v1/all_methods_5seed_kir.png`：Trainable、固定 K、随机分区和 MOGB 组件曲线。
- `figures/archive/analysis/minilm_trainable_5seed_fair_v1/all_methods_known_oos_tradeoff_5seed.png`：Known Recall–OOS F1 权衡。
- `figures/archive/analysis/minilm_trainable_5seed_fair_v1/trainable_vs_fulltex_reference.png`：历史 fulltex 参照图。
