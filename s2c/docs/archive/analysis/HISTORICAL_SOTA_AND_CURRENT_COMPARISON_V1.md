...
在 9 个历史 dataset×KIR 格子中，Ours 的 OOS F1 高于该格所有七个列出的基线的格子数为 9。逐格差值见 `results/analysis/archive/analysis/historical_sota_comparison_v1/ours_minus_best_baseline.csv`。
