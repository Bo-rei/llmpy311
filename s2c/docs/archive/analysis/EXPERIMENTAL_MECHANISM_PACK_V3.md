...
- 输入：`results/analysis/archive/analysis/minilm_trainable_5seed_fair_v1/all_methods_per_seed.csv`，SHA256=`c981f5f887c49ed2360d51a6ad0bfb061fb60a79b42f95fda13ca4485cfb9a3d`。
...
- `figures/archive/analysis/experimental_mechanism_pack_v3/`：热图、KIR 曲线、工作点散点和差值热图。
