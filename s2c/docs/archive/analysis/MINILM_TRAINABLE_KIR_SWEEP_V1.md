...
- `figures/archive/analysis/minilm_trainable_kir_sweep_v1/trainable_vs_frozen_kir.png`：三数据集 KIR 曲线。
- `figures/archive/analysis/minilm_trainable_kir_sweep_v1/trainable_known_oos_tradeoff_kir.png`：Known Recall/OOS F1 权衡。
- `figures/archive/analysis/minilm_trainable_kir_sweep_v1/trainable_minus_frozen_kir_heatmap.png`：训练相对冻结的 KIR 热图。
- `figures/archive/analysis/minilm_trainable_kir_sweep_v1/trainable_fair_component_context.png`：与同协议 Frozen/MOGB 组件的上下文比较。
