...
下表为三个 data seed 的均值；`false_accept` 使用现有结果文件中的 OOS 接受率口径。完整逐 seed 数据见 [`representation_k1_k2_summary.csv`](../../results/analysis/archive/analysis/representation_boundary_pack_v1/representation_k1_k2_summary.csv)。
...
- [`representation_k1_k2_summary.csv`](../../results/analysis/archive/analysis/representation_boundary_pack_v1/representation_k1_k2_summary.csv)
- [`representation_k2_minus_k1.csv`](../../results/analysis/archive/analysis/representation_boundary_pack_v1/representation_k2_minus_k1.csv)
- [`representation_geometry.csv`](../../results/analysis/archive/analysis/representation_boundary_pack_v1/representation_geometry.csv)
- [`representation_oos_f1_k1_k2.png`](../../figures/archive/analysis/representation_boundary_pack_v1/representation_oos_f1_k1_k2.png)
- [`representation_near_oos_f1_k1_k2.png`](../../figures/archive/analysis/representation_boundary_pack_v1/representation_near_oos_f1_k1_k2.png)
- [`representation_known_recall_k1_k2.png`](../../figures/archive/analysis/representation_boundary_pack_v1/representation_known_recall_k1_k2.png)
- [`representation_geometry_summary.png`](../../figures/archive/analysis/representation_boundary_pack_v1/representation_geometry_summary.png)
