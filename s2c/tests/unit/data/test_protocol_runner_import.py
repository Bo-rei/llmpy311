...
def test_protocol_runner_builds_active_detector_through_public_gate_package(tmp_path: Path) -> None:
...
from protocol_v2.experiments.runner import _build_detector
